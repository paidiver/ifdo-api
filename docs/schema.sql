...
ALTER TABLE ONLY public.annotation_set_creators
    ADD CONSTRAINT annotation_set_creators_pkey PRIMARY KEY (annotation_id, creator_id);
...
ALTER TABLE ONLY public.annotation_set_image_sets
    ADD CONSTRAINT annotation_set_image_sets_pkey PRIMARY KEY (annotation_id, image_set_id);
...
--
-- Name: annotation_set_creators annotation_set_creators_annotation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.annotation_set_creators
    ADD CONSTRAINT annotation_set_creators_annotation_id_fkey FOREIGN KEY (annotation_id) REFERENCES public.annotations(id) ON DELETE CASCADE;
...
--
-- Name: annotation_set_image_sets annotation_set_image_sets_annotation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.annotation_set_image_sets
    ADD CONSTRAINT annotation_set_image_sets_annotation_id_fkey FOREIGN KEY (annotation_id) REFERENCES public.annotations(id) ON DELETE CASCADE;
