...
Revision ID: 0085dc77c056
Revises: 
Create Date: 2025-07-18 11:15:23.595101
...
def upgrade() -> None:
    ...
    sa.Column('camera_pose_id', sa.Integer(), nullable=True),
    sa.Column('camera_housing_viewport_id', sa.Integer(), nullable=True),
    sa.Column('flatport_parameter_id', sa.Integer(), nullable=True),
    sa.Column('domeport_parameter_id', sa.Integer(), nullable=True),
    sa.Column('photometric_calibration_id', sa.Integer(), nullable=True),
    sa.Column('camera_calibration_model_id', sa.Integer(), nullable=True),
    ...
    sa.Column('altitude_meters', sa.Float(), nullable=False),
    ...
    sa.Column('acquisition', sa.Enum('photo', 'video', 'slide', name='acquisitionenum'), nullable=False),
    sa.Column('quality', sa.Enum('raw', 'processed', 'product', name='qualityenum'), nullable=False),
    sa.Column('deployment', sa.Enum('mapping', 'stationary', 'survey', 'exploration', 'experiment', 'sampling', name='deploymentenum'), nullable=False),
    sa.Column('navigation', sa.Enum('satellite', 'beacon', 'transponder', 'reconstructed', name='navigationenum'), nullable=False),
    sa.Column('scale_reference', sa.Enum('camera_3d', 'camera_calibrated', 'laser_marker', 'optical_flow', name='scalereferenceenum'), nullable=False),
    sa.Column('illumination', sa.Enum('sunlight', 'artificial_light', 'mixed_light', name='illuminationenum'), nullable=False),
    sa.Column('pixel_magnitude', sa.Enum('km', 'hm', 'dam', 'm', 'cm', 'mm', 'um', name='pixelmagnitudeenum'), nullable=False),
    sa.Column('marine_zone', sa.Enum('seafloor', 'water_column', 'sea_surface', 'atmosphere', 'laboratory', name='marinezoneenum'), nullable=False),
    sa.Column('spectral_resolution', sa.Enum('grayscale', 'rgb', 'multi_spectral', 'hyper_spectral', name='spectralresenum'), nullable=False),
    sa.Column('capture_mode', sa.Enum('timer', 'manual', 'mixed', name='capturemodeenum'), nullable=False),
    sa.Column('fauna_attraction', sa.Enum('none', 'baited', 'light', name='faunaattractionenum'), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('camera_calibration_model_id'),
    sa.UniqueConstraint('camera_housing_viewport_id'),
    sa.UniqueConstraint('camera_pose_id'),
    sa.UniqueConstraint('domeport_parameter_id'),
    sa.UniqueConstraint('flatport_parameter_id'),
    sa.UniqueConstraint('photometric_calibration_id'),
    sa.UniqueConstraint('uuid')
    )
    op.create_geospatial_index('idx_datasets_location', 'datasets', ['location'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    sa.ForeignKeyConstraint(['dataset_id'], ['datasets.id'], ),
    sa.ForeignKeyConstraint(['material_id'], ['image_set_related_materials.id'], ),
    sa.PrimaryKeyConstraint('dataset_id', 'material_id')
    )
    op.create_table('datasets_creators',
    sa.Column('dataset_id', sa.Integer(), nullable=False),
    sa.Column('creator_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['creator_id'], ['image_creators.id'], ),
    sa.ForeignKeyConstraint(['dataset_id'], ['datasets.id'], ),
    ...
    sa.ForeignKeyConstraint(['camera_pose_id'], ['image_camera_poses.id'], ),
    sa.ForeignKeyConstraint(['context_id'], ['image_contexts.id'], onupdate='CASCADE', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['dataset_id'], ['datasets.uuid'], onupdate='CASCADE', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['domeport_parameter_id'], ['image_domeport_parameters.id'], ),
    sa.ForeignKeyConstraint(['event_id'], ['image_events.id'], onupdate='CASCADE', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['flatport_parameter_id'], ['image_flatport_parameters.id'], ),
    sa.ForeignKeyConstraint(['license_id'], ['image_licenses.id'], onupdate='CASCADE', ondelete='SET NULL'),
    ...
    op.create_geospatial_index('idx_images_location', 'images', ['location'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    sa.Column('annotation_label_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_geospatial_index('idx_images_location', table_name='images', postgresql_using='gist', column_name='location')
    ...
    op.drop_geospatial_index('idx_datasets_location', table_name='datasets', postgresql_using='gist', column_name='location')
